...
This hook can either be called  from the `jumpbox` or the `undercloud`. You can for
instance use the `delegate_to` key word to ensure the tasks will be evaluated on the
correct host.
