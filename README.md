...
You are here? This is good news because you have a working automated agent running on your remoteci. We can now automate your server to run jobs automatically
...
Distributed-CI is a rolling release. We publish updates every [day, week, month,] and we expect our users to keep their jumpbox up to date.
